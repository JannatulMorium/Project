...
public class PAINT2 extends JFrame
{
		...
		JButton brushBut, lineBut, ellipseBut, rectBut, strokeBut, fillBut,eraser ;
        ...
        public PAINT2()
        {
            ...
            ellipseBut = makeMeButtons("./src/CIRCLE.png", 3);
            rectBut = makeMeButtons("./src/SQAURE1.png", 4);
          
            
            strokeBut = makeMeColorButton("./src/fill1.png", 5, true);
            fillBut = makeMeColorButton("./src/full.png", 6, false);
            eraser=makeMeButtons("",7);
